...
try:
    from modules.financehub.backend.api.endpoints.ai.models import router as models_router  # noqa: E402
except ModuleNotFoundError as e:
    import logging
    logging.getLogger(__name__).warning("AI models router disabled – missing dependency %s", e)
