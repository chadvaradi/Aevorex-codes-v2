"""ECB Consolidated Banking Data endpoint"""
...
router = APIRouter(prefix="/cbd", tags=["ECB CBD"])
...
async def get_cbd(
    ...
    try:
        data = await _svc(cache).get_ecb_cbd(start, end)
    ...
    if not data:
        return {
            ...
            "metadata": {
                "source": "ECB SDMX (CBD)",
                "message": "Consolidated banking statistics unavailable – empty payload",
            },
            "data": {},
        }
