...
from modules.financehub.backend.core.fetchers.macro.fred_client import _fetch_series_observations
...
async def get_series_observations(
    ...
    frequency: Optional[str] = Query(None, description="FRED frequency param, e.g., m,q,a"),
    units: Optional[str] = Query(None, description="FRED units param, e.g., pc1 (YoY %)"),
    ...
    _t0 = perf_counter()
    data = await _fetch_series_observations(http, api_key, series_id, start_date, end_date, frequency, units)
