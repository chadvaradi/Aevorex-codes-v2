...
class AISettings(BaseModel):
    ...
    MODEL_NAME_PRIMARY: str | None = "google/gemini-2.0-flash-001"
    MODEL_NAME_FALLBACK: str | None = "openai/gpt-4o-mini"
    ...
    model_config = SettingsConfigDict(env_prefix='FINBOT_AI__', env_file='env.local', extra='ignore') 