...
class StripeSettings(BaseSettings):
    ...
    STRIPE_TEAM_MONTHLY_PRICE_ID: Optional[str] = Field(
        default=None, 
        description="Stripe Team monthly price ID"
    )
    STRIPE_TEAM_YEARLY_PRICE_ID: Optional[str] = Field(
        default=None, 
        description="Stripe Team yearly price ID"
    )
    STRIPE_ENTERPRISE_MONTHLY_PRICE_ID: Optional[str] = Field(
        default=None, 
        description="Stripe Enterprise monthly price ID"
    )
    STRIPE_ENTERPRISE_YEARLY_PRICE_ID: Optional[str] = Field(
        default=None, 
        description="Stripe Enterprise yearly price ID"
    )
...
class LemonSqueezySettings(BaseSettings):
    ...
    LEMON_SQUEEZY_PRO_MONTHLY_VARIANT_ID: Optional[str] = Field(
        default=None, 
        description="Lemon Squeezy Pro monthly variant ID"
    )
    LEMON_SQUEEZY_PRO_YEARLY_VARIANT_ID: Optional[str] = Field(
        default=None, 
        description="Lemon Squeezy Pro yearly variant ID"
    )
    LEMON_SQUEEZY_TEAM_MONTHLY_VARIANT_ID: Optional[str] = Field(
        default=None, 
        description="Lemon Squeezy Team monthly variant ID"
    )
    LEMON_SQUEEZY_TEAM_YEARLY_VARIANT_ID: Optional[str] = Field(
        default=None, 
        description="Lemon Squeezy Team yearly variant ID"
    )
    LEMON_SQUEEZY_ENTERPRISE_MONTHLY_VARIANT_ID: Optional[str] = Field(
        default=None, 
        description="Lemon Squeezy Enterprise monthly variant ID"
    )
    LEMON_SQUEEZY_ENTERPRISE_YEARLY_VARIANT_ID: Optional[str] = Field(
        default=None, 
        description="Lemon Squeezy Enterprise yearly variant ID"
    )
...
class PaddleSettings(BaseSettings):
    ...
    PADDLE_PRO_MONTHLY_PLAN_ID: Optional[str] = Field(
        default=None, 
        description="Paddle Pro monthly plan ID"
    )
    PADDLE_PRO_YEARLY_PLAN_ID: Optional[str] = Field(
        default=None, 
        description="Paddle Pro yearly plan ID"
    )
    PADDLE_TEAM_MONTHLY_PLAN_ID: Optional[str] = Field(
        default=None, 
        description="Paddle Team monthly plan ID"
    )
    PADDLE_TEAM_YEARLY_PLAN_ID: Optional[str] = Field(
        default=None, 
        description="Paddle Team yearly plan ID"
    )
    PADDLE_ENTERPRISE_MONTHLY_PLAN_ID: Optional[str] = Field(
        default=None, 
        description="Paddle Enterprise monthly plan ID"
    )
    PADDLE_ENTERPRISE_YEARLY_PLAN_ID: Optional[str] = Field(
        default=None, 
        description="Paddle Enterprise yearly plan ID"
    )
    
    # Feature flags
    PADDLE_ENABLED: bool = Field(
        default=False, 
        description="Whether Paddle is enabled"
    )
...
class SubscriptionSettings(BaseSettings):
    ...
    GRACE_PERIOD_DAYS: int = Field(
        default=3, 
        description="Grace period in days for past due subscriptions"
    )
    ...
    FREE_PLAN_DAILY_REQUESTS: int = Field(
        default=100, 
        description="Daily request limit for free plan"
    )
    PRO_PLAN_DAILY_REQUESTS: int = Field(
        default=1000, 
        description="Daily request limit for Pro plan"
    )
    TEAM_PLAN_DAILY_REQUESTS: int = Field(
        default=5000, 
        description="Daily request limit for Team plan"
    )
    ENTERPRISE_PLAN_DAILY_REQUESTS: int = Field(
        default=50000, 
        description="Daily request limit for Enterprise plan"
    )
