...
# --- Core Helper Imports ---
try:
    from ..utils.helpers import parse_optional_float
except ImportError as e:
    import logging
    logging.basicConfig(level="CRITICAL")
    logging.getLogger(__name__).critical(f"FATAL ERROR: Cannot import helpers: {e}", exc_info=True)
...
def map_eodhd_splits_data_to_models(
    ...
    for idx_date, row in df_copy.iterrows():
        ...
        try:
            ...
            entry_data = {
                'date': split_date, 'split_ratio_str': ratio_str,
                'split_to': split_to_val, 'split_from': split_from_val
            }
...
def map_eodhd_dividends_data_to_models(
    ...
    for index, row in df_copy.iterrows():
        ...
        try:
            ...
            entry_data = {
                'date': ex_div_date, 'dividend': amount,
