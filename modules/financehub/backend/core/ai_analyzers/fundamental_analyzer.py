...
from modules.financehub.backend.core.ai_analyzers.models import MarketData
...
class FundamentalAnalyzer:
    ...
    def analyze(self, market_data: dict[str, Any]) -> dict[str, str]:
        ...
        try:
            ...
            raise ValueError(f"Nem teljesek a bemeneti adatok a fundamentális elemzéshez: {e}") from e
