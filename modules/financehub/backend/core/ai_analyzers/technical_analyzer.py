...
from modules.financehub.backend.core.ai_analyzers.models import TechnicalIndicators
...
class TechnicalAnalyzer:
    def analyze(self, chart_data: dict) -> TechnicalIndicators:
        ...
        volume_trend = "Increasing" if volumes[-1] > statistics.mean(volumes) else "Decreasing"
