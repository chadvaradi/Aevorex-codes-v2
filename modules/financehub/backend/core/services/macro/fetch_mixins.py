...
class ECBStandardMixin:
    ...
    async def get_ecb_policy_rates(self, start_date: Optional[date] = None, end_date: Optional[date] = None):
    ...
    async def get_ecb_yield_curve(self, start_date: Optional[date] = None, end_date: Optional[date] = None):
        from datetime import date as _d, timedelta as _td
    ...
    async def get_ecb_fx_rates(self, start_date: Optional[date] = None, end_date: Optional[date] = None):
        from datetime import date as _d, timedelta as _td
        ...
        if start_date is None:
            start_date = end_date - _td(days=90)
        return await self._get_with_cache_fallback(
            lambda: self.ecb_client.get_fx_rates(start_date=start_date, end_date=end_date),
            cache_key,
        )

    async def get_ecb_retail_rates(self, start_date: Optional[date] = None, end_date: Optional[date] = None):
        ...
        async def _fetch():
            ...
            if not data:
                ...
                if policy:
                    data = {d: {"deposit_rate": v.get("deposit_facility_rate"), "lending_rate": v.get("marginal_lending_facility_rate")}
                            for d, v in policy.items()}
            return data
        return await self._get_with_cache_fallback(_fetch, cache_key)

    # ---- Previously added wrappers (MIR, STS, etc.) ----------------
    async def get_ecb_mir(self, start_date: Optional[date] = None, end_date: Optional[date] = None):
        return await self.get_ecb_retail_rates(start_date, end_date)

    async def get_ecb_sts(self, start_date: Optional[date] = None, end_date: Optional[date] = None):
    ...
    async def get_ecb_bop(self, start_date: Optional[date] = None, end_date: Optional[date] = None):
    ...
    async def get_ecb_sec(self, start_date: Optional[date] = None, end_date: Optional[date] = None):
        from modules.financehub.backend.core.fetchers.macro.ecb_client.sec_fetcher import (
            fetch_ecb_sec_data,
        )
    ...
    async def get_ecb_ivf(self, start_date: Optional[date] = None, end_date: Optional[date] = None):
    ...
    async def get_ecb_cbd(self, start_date: Optional[date] = None, end_date: Optional[date] = None):
    ...
    async def get_ecb_rpp(self, start_date: Optional[date] = None, end_date: Optional[date] = None):
        cache_key = f"ecb:rpp:{start_date}:{end_date or 'latest'}"
        from modules.financehub.backend.core.fetchers.macro.ecb_client import fetch_ecb_rpp_data
        return await self._get_with_cache_fallback(
            lambda: fetch_ecb_rpp_data(self._cache, start_date, end_date),
            cache_key,
        )

    async def get_ecb_cpp(self, start_date: Optional[date] = None, end_date: Optional[date] = None):
        cache_key = f"ecb:cpp:{start_date}:{end_date or 'latest'}"
        from modules.financehub.backend.core.fetchers.macro.ecb_client import fetch_ecb_cpp_data
        return await self._get_with_cache_fallback(
            lambda: fetch_ecb_cpp_data(self._cache, start_date, end_date),
            cache_key,
        )

    async def get_ecb_bls(self, start_date: Optional[date] = None, end_date: Optional[date] = None):
        cache_key = f"ecb:bls:{start_date}:{end_date or 'latest'}"
        from modules.financehub.backend.core.fetchers.macro.ecb_client import fetch_ecb_bls_data
        return await self._get_with_cache_fallback(
            lambda: fetch_ecb_bls_data(self._cache, start_date, end_date),
            cache_key,
        )

    async def get_ecb_spf(self, start_date: Optional[date] = None, end_date: Optional[date] = None):
        cache_key = f"ecb:spf:{start_date}:{end_date or 'latest'}"
        from modules.financehub.backend.core.fetchers.macro.ecb_client import fetch_ecb_spf_data
        return await self._get_with_cache_fallback(
            lambda: fetch_ecb_spf_data(self._cache, start_date, end_date),
            cache_key,
        )

    async def get_ecb_ciss(self, start_date: Optional[date] = None, end_date: Optional[date] = None):
        cache_key = f"ecb:ciss:{start_date}:{end_date or 'latest'}"
        from modules.financehub.backend.core.fetchers.macro.ecb_client import fetch_ecb_ciss_data
        return await self._get_with_cache_fallback(
            lambda: fetch_ecb_ciss_data(self._cache, start_date, end_date),
            cache_key,
        )

    async def get_ecb_estr_rate(self, start_date: Optional[date] = None, end_date: Optional[date] = None):
        cache_key = f"ecb:estr:{start_date}:{end_date or 'latest'}"
        from modules.financehub.backend.core.fetchers.macro.ecb_client import fetch_ecb_estr_rate
        return await self._get_with_cache_fallback(
            lambda: fetch_ecb_estr_rate(self._cache, start_date, end_date),
            cache_key,
        )

    async def get_ecb_pss(self, start_date: Optional[date] = None, end_date: Optional[date] = None):
        from modules.financehub.backend.core.fetchers.macro.ecb_client.pss_fetcher import (
            fetch_ecb_pss_data,
        )
    ...
    async def get_ecb_irs(self, start_date: Optional[date] = None, end_date: Optional[date] = None):
        from modules.financehub.backend.core.fetchers.macro.ecb_client.irs_fetcher import (
            fetch_ecb_irs_data,
        )
    ...
    async def get_ecb_hicp(self, start_date: Optional[date] = None, end_date: Optional[date] = None):
    ...
    async def get_ecb_bsi(self, start_date: Optional[date] = None, end_date: Optional[date] = None):
    ...
    async def get_ecb_inflation_indicators(self, start_date: Optional[date] = None, end_date: Optional[date] = None):
    ...
    async def get_ecb_trd(self, start_date: Optional[date] = None, end_date: Optional[date] = None):
        from modules.financehub.backend.core.fetchers.macro.ecb_client.trd_fetcher import (
            fetch_ecb_trd_data,
        )
