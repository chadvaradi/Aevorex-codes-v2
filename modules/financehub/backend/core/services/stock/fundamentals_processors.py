...
class FundamentalsProcessor:
    ...
    def process_company_info(self, ticker_info: dict[str, Any], symbol: str) -> dict[str, Any]:
        """Process raw ticker info into structured company overview."""
        return {
            "symbol": symbol,
            "name": ticker_info.get("longName") or ticker_info.get("shortName") or symbol,
    ...
    def format_basic_summary(self, ticker_info: dict[str, Any], symbol: str) -> dict[str, Any]:
