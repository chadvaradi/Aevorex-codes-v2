...
class OpenRouterGateway:
    ...
    async def stream_completion(
        ...
        *,
        ...
        api_key = settings.API_KEYS.OPENROUTER.get_secret_value() if settings.API_KEYS.OPENROUTER else None
        if not api_key:
        ...
        async with self.client.stream("POST", url, headers=headers, json=payload, timeout=settings.AI.TIMEOUT_SECONDS) as resp:
