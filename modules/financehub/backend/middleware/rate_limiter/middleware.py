...
class RateLimiterMiddleware(BaseHTTPMiddleware):
    ...
    def _create_rate_limit_response(self, limit: int, remaining: int, 
                                  reset_time: int, window: int) -> JSONResponse:
        """
    ...
    def _add_rate_limit_headers(self, response: Response, limit: int, 
                               remaining: int, reset_time: int, window: int):
        """
