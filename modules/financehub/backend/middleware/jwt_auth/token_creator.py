...
class JWTTokenCreator:
    ...
    def __init__(self, secret_key: str, algorithm: str = "HS256",
                 token_expiration: int = 900, redis_client: Optional[redis.Redis] = None):
    ...
    async def refresh_token(self, token: str) -> str:
        ...
        try:
            ...
            if iat and datetime.utcfromtimestamp(iat) < datetime.utcnow() - timedelta(seconds=max_age):
                raise HTTPException(
