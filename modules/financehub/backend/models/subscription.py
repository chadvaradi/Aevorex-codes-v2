...
class User(BaseModel):
    ...
    auth_provider_id: Optional[str] = Field(None, description="External auth provider ID")
...
class UserWithSubscription(BaseModel):
    ...
    def has_active_subscription(self) -> bool:
        ...
        if not self.subscription:
            return False
        return self.subscription.status in [SubscriptionStatus.ACTIVE, SubscriptionStatus.TRIALING]
