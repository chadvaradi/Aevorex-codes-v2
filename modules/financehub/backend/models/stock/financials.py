...
class FinancialStatementItem(BaseModel):
    date: str = Field(..., description="The date of the financial data point (e.g., '2023-12-31').")
    value: Optional[float] = Field(None, description="The value of the financial metric.")

class FinancialStatementData(BaseModel):
    quarterly: List[FinancialStatementItem] = Field(default_factory=list, description="List of quarterly data points.")
    annual: List[FinancialStatementItem] = Field(default_factory=list, description="List of annual data points.")
    ...
    class Config:
        ...
        json_schema_extra = {
            "example": {
                "balance_sheet": {
                    "quarterly": [{"date": "2023-09-30", "value": 1000}, {"date": "2023-06-30", "value": 950}],
